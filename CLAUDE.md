...
- **Kartu produk bergambar**: gambar 4:3 di atas, nama, harga paling bawah; grid 2 kolom di HP, 3 kolom mulai ≥768px (dipakai juga oleh Pre-order dan Tambah Item — komponen yang sama). Konsekuensi yang disadari: kartu lebih tinggi, jadi di tablet 1180×820 kelihatan 2 baris produk sekaligus (6 produk) sebelum scroll.
