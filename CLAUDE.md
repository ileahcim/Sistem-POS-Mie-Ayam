...
- **Bakso Kecil (3 biji) Rp5.000** (HPP estimasi 3.300 = 3 × 1.100, sejalan dengan harga bakso mentah 5.000 per 3 biji) dan **Bakso Setengah (4 biji) Rp8.000** (HPP estimasi 5.000 — ini semangkok lengkap dengan mi/sayur/kuah porsi setengah, jadi modalnya setengah dari Bakso biasa yang 10.000, bukan cuma harga baksonya; untung 3.000 seperti pola menu lain). Keduanya di kategori Makanan, di bawah baris "(bijian)", **tanpa grup add-on** (barang satuan/porsi kecil, tidak dikustom).
