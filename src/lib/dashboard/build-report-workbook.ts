...
export async function buildReportWorkbook(): Promise<ExcelJS.Workbook> {
  ...
  shiftSheet.columns = [
    ...
    { header: "Pelunasan Piutang (Tunai)", key: "receivableSettledCash", width: 24, style: { numFmt: MONEY_FORMAT } },
    { header: "Pelunasan Piutang (QRIS)", key: "receivableSettledNonCash", width: 24, style: { numFmt: MONEY_FORMAT } },
    { header: "Pelunasan Masuk Kantong", key: "receivablePocketCash", width: 23, style: { numFmt: MONEY_FORMAT } },
