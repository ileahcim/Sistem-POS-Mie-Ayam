...
// Utang tab of the Buku Frozen — a fully separate ledger from Mi Mentah and
// from the POS itself (CLAUDE.md "Buku Frozen"). Mirrors note-screen.tsx's
// shape exactly.
    ...
    <div className="bg-canvas flex h-dvh flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="mx-auto flex max-w-3xl flex-col gap-4">
          <NoteNav book="frozen" section="utang" />
          ...
          <div className="flex flex-wrap gap-2">
            <LinkButton href={NOTE_BOOK.frozen.newCustomerHref} variant="secondary" className="border-border border">
              + Pelanggan
            </LinkButton>
            <LinkButton href="/note/produk?dari=frozen" variant="ghost">
              Harga Produk
            </LinkButton>
            <a href={NOTE_BOOK.frozen.exportHref} className={buttonClassName("ghost", "default", false)}>
              Export Excel
            </a>
          </div>
