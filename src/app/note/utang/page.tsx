...
// Utang tab. OWNER only, checked server-side here — see CLAUDE.md
// "Server-side authorization". Every action in note/actions.ts also
// requireRole("OWNER") itself, since those are independent entry points this
// redirect doesn't protect.
export default async function NoteDebtPage() {
