...
// Utang tab of the Buku Frozen. OWNER only, checked server-side here — see
// CLAUDE.md "Server-side authorization". Every action in
// note/frozen-actions.ts also requireRole("OWNER") itself.
export default async function FrozenDebtPage() {
  ...
  return <FrozenScreen customers={customers} summary={summary} nav={nav} />;
}
