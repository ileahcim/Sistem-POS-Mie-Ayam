...
export default async function MenuAdminPage() {
  ...
  const [{ categories, addonGroups }, nav] = await Promise.all([getMenuAdminData(), getHeaderNav()]);
  return <MenuAdminScreen categories={categories} addonGroups={addonGroups} nav={nav} />;
}
